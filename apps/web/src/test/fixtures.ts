...
export const healthDetailsNotReadyFixture: HealthDetailsResponse = {
  ...
  checks: [
    ...
    },
    {
      ...
      ok: false,
      detail:
        "One or more roles are not bound. Run scripts/sync_foundry_agents.py --apply.",
    },
  ],
  warnings: [
    "Azure AI Foundry project endpoint is not configured. Recommendation requests will fail.",
  ],
  guidance: "Not demo-ready. Finish Terraform + .env setup + sync_foundry_agents.py --apply.",
};
...
export const recommendationFixture: Recommendation = {
  ...
  generated_by:
    "Generated by three collaborating agents via Azure AI Foundry Agent Service (remote agents).",
};
...
export const envelopeOkFixture: RecommendationEnvelope = {
  ...
  provider_model: "Azure AI Foundry Agent Service (remote agents)",
};
